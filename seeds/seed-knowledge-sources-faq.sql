...
DELETE FROM knowledge_sources WHERE source_type = 'real_faq' AND tenant_id = 'tenant_default';

INSERT INTO knowledge_sources (tenant_id, url, title, content, metadata, source_type, priority, category, is_active, created_at, updated_at) VALUES (
  'tenant_default',
  NULL,
  '顧客頻出質問 — 入金',
  '# 顧客頻出質問 — 入金
